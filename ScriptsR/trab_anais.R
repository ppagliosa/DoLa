trab_anais <- function(id, xml_data, 
                       pontos_anais = function(FUN, natureza) {FUN(natureza)},
                       dic_id_cit,
                       ano_ini, ano_fim){
...
#        tipo <- xml_data$"PRODUCAO-BIBLIOGRAFICA"$"TRABALHOS-EM-EVENTOS"[[i]]$"DETALHAMENTO-DO-TRABALHO"["CLASSIFICACAO-DO-EVENTO"]
...
#              if(as.vector(xml_data$"PRODUCAO-BIBLIOGRAFICA"$"TRABALHOS-EM-EVENTOS"[i]$"TRABALHO-EM-EVENTOS"$"AUTORES"["NRO-ID-CNPQ"]) %in% as.vector(clattes$id)) docente <- "Docente"   #################
#              if(as.vector(xml_data$"PRODUCAO-BIBLIOGRAFICA"$"TRABALHOS-EM-EVENTOS"[i]$"TRABALHO-EM-EVENTOS"$"AUTORES"["NRO-ID-CNPQ"]) == as.vector(id)) docente = ""
...
#            if(as.vector(xml_data$"PRODUCAO-BIBLIOGRAFICA"$"TRABALHOS-EM-EVENTOS"[i]$"TRABALHO-EM-EVENTOS"$"AUTORES"["NOME-COMPLETO-DO-AUTOR"]) %in% as.vector(clattes$nome)) docente = "Docente" #################
...
#            if(as.vector(xml_data$"PRODUCAO-BIBLIOGRAFICA"$"TRABALHOS-EM-EVENTOS"[i]$"TRABALHO-EM-EVENTOS"$"AUTORES"["NOME-PARA-CITACAO"]) %in% as.vector(clattes$nome)) docente = "Docente" #################

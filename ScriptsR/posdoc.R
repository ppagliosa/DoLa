...
posdoc <- function(id, xml_data,
                   pontos_posdoc = function(FUN, item) {FUN(item)},
                   ano_ini, ano_fim) {
...
#        posd.pd<-posd[[i]]
#        instituicao<-posd.pd$"POS-DOUTORADO"$".attrs"["NOME-INSTITUICAO"]
#        ano<-as.vector(posd.pd$"POS-DOUTORADO"$".attrs"["ANO-DE-CONCLUSAO"])
#        ano_inicio <-posd.pd$"POS-DOUTORADO"$".attrs"["ANO-DE-INICIO"]
#  instituicao<-posd[i]$"POS-DOUTORADO"$".attrs"["NOME-INSTITUICAO"]
#  ano<- as.vector(posd[i]$"POS-DOUTORADO"$".attrs"["ANO-DE-CONCLUSAO"])
#  ano_inicio <-posd[i]$"POS-DOUTORADO"$".attrs"["ANO-DE-INICIO"]
...
#        posd.ld<-posd[[i]]
#        instituicao<-posd.ld$"LIVRE-DOCENCIA"["NOME-INSTITUICAO"]
#        ano<-as.vector(posd.ld$"LIVRE-DOCENCIA"["ANO-DE-OBTENCAO-DO-TITULO"])
#  instituicao<-posd[i]$"LIVRE-DOCENCIA"["NOME-INSTITUICAO"]
#  ano<- as.vector(posd[i]$"LIVRE-DOCENCIA"["ANO-DE-OBTENCAO-DO-TITULO"])

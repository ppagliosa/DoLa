...
#                              orientacao(id, xml_data, pontos_orientacao, nome_instituicao, nome_ppg, ano_ini, ano_fim))
  producao_orientacoes <- rbind(producao_orientacoes,
...
#                              banca(id, xml_data, pontos_banca, nome_instituicao, nome_ppg, ano_ini, ano_fim))
  producao_bancas <- rbind(producao_bancas,
...
#                          disciplina(id, xml_data, pontos_disciplina, nome_instituicao, nome_ppg, ano_ini, ano_fim))
  producao_disciplinas <- rbind(producao_disciplinas,
